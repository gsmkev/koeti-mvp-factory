...
export const openApiSpec = {
  openapi: '3.1.0',
  info: {
    title: 'Koeti SaaS API',
    version: '1.0.0',
    description:
      'HTTP surface of the SaaS template: health, current user/team, Stripe ' +
      'checkout/webhook, and Google OAuth. Other MVPs authenticate to data ' +
      'routes with a team API key (`Authorization: Bearer koeti_…`).',
  },
