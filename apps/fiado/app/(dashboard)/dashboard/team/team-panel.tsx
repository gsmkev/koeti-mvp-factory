'use client';
// Client content for /dashboard/team — page.tsx gates access (admin+) and
// renders this.
...
import { customerPortalFormAction } from '@/lib/payments/actions';
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <form action={customerPortalFormAction}>
