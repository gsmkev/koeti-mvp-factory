'use client';
// Client content for /dashboard/security — page.tsx gates access and
// renders this.
...
// wired for a future admin-facing flow if that's ever needed. Own password
// change stays self-service for everyone, though — an owner can still reset
// it for someone via the edit dialog on /dashboard/team if needed.
