...
// Scaffold a new SaaS app from the template, then provision its DB and install deps.
...
for (const file of filesToPatch) {
  ...
  const patched = content.replaceAll('saas-template', name).replaceAll('saas_template', dbName);
