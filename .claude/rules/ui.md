...
**Invoke `design-taste-frontend` before implementing any new page or component.** Pass the SaaS spec summary so it infers the right aesthetic. Do not skip this step.
